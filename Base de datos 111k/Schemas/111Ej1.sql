...
--
-- Create schema ejercicio1anio2013
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ 111kej1;
USE 111kej1;

--
-- Table structure for table `ejercicio1anio2013`.`cliente`
--
...
--
-- Dumping data for table `111kej1`.`cliente`
--
...
--
-- Table structure for table `111kej1`.`factura`
--
...
--
-- Dumping data for table `111kej1`.`factura`
--
...
--
-- Table structure for table `111kej1`.`itemfactura`
--
...
--
-- Dumping data for table `111kej1`.`itemfactura`
--
...
--
-- Table structure for table `111kej1`.`producto`
--
...
--
-- Dumping data for table `111kej1`.`producto`
--
